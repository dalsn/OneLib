...
function getConnection() {
	...
	global $db_OneLib_db_Url, $db_OneLib_db_User, $db_OneLib_db_Pass, $db_OneLib_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_OneLib_db_Url.";dbname=".$db_OneLib_db_DbName, $db_OneLib_db_User, $db_OneLib_db_Pass);
